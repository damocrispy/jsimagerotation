class Rotator {
   ...
   rotate = function (theta) {
      ...
      let width = Math.abs(this.imgIn.height * Math.sin(theta)) + Math.abs(this.imgIn.width * Math.cos(theta));
      let height = Math.abs(this.imgIn.width * Math.sin(theta)) + Math.abs(this.imgIn.height * Math.cos(theta));
